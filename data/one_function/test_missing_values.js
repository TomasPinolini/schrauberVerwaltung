 ...
 * 
 * This script analyzes payload files to see how many contain the values for:
 * - Drehmoment_Min
 * - Drehmoment_Max
 * - Winkel_Nom
 * - Winkel_Ist
 ...
 * 
 * This version processes only the first 5 payloads from each file for quick analysis.
 */

const fs = require('fs');
const path = require('path');

// Paths - Updated for one_function folder
