...
try {
  ...
  const payloadName = ch.name || "MFV23_Halle101_11461CP";
  ...
  // Common fields
  const Datum = new Date(ch.date || new Date()).toISOString().slice(0,19).replace('T',' ');
  ...
  msg.error = {
    ...
    timestamp: new Date().toISOString(),
    controller: 'MFV23_Halle101_11461CP',
